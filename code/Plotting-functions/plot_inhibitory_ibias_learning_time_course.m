function plot_inhibitory_ibias_learning_time_course(t,iext,stim_spike,diff,rule1I,rule2I)
...
ylab = ylabel('$I_{\rm bias}2$ (mA)','Interpreter', 'Latex','fontsize',18);
